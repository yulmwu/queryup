...
export class Init1774009753988 implements MigrationInterface {
    name = 'Init1774009753988'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "general_posts" ("id" SERIAL NOT NULL, "title" character varying(200) NOT NULL, "content" text NOT NULL, "isDeleted" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" integer, CONSTRAINT "PK_52132fe81d41334fdfc3c0d3df0" PRIMARY KEY ("id"))`,
        )
        await queryRunner.query(`CREATE INDEX "IDX_5953c968cd6fb6972f1de83ced" ON "general_posts" ("isDeleted") `)
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "general_posts" ADD CONSTRAINT "FK_f73a654a11f4cd750654a4ae5ce" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        )
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "general_posts" DROP CONSTRAINT "FK_f73a654a11f4cd750654a4ae5ce"`)
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5953c968cd6fb6972f1de83ced"`)
        await queryRunner.query(`DROP TABLE "general_posts"`)
